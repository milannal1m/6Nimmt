...
const GameCard SmartBot::chooseCard(const std::shared_ptr<Field> matchField)
{
...
const int SmartBot::chooseRow(const std::shared_ptr<Field> matchField) const
{
...
const GameCard SmartBot::CardWithLowestDiff(const std::shared_ptr<Field> matchField, const std::vector<GameCard>Hand)
{
	int currentDiff = 105;
...
const GameCard SmartBot::CardThatGoesShortestRow(const std::shared_ptr<Field> matchField, const std::vector<GameCard>Hand)
{
	int rowSize = 0;
	int row = 0;
...
const int SmartBot::findShortestRowSizeInHand(const std::shared_ptr<Field> matchField, const std::vector<GameCard> Hand)
{
	int rowSize = 0;
	int row = 0;
	int currentShortestRowSize = 7;
...
const GameCard SmartBot::RandomCard(const std::vector<GameCard>Hand)
{
...
const GameCard SmartBot::Lowestcard(const std::vector<GameCard> Hand)
{
